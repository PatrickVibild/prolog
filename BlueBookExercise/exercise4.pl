...
[1|[2|[3|[4]]]] % 4
[1,2,3,4|[]]$ % 4
[[]|[]] % 1 [[]] contains a empty list
[[1,2]|4] % wrong. Second argument need to be always a list.
...
%listtran([], []).
%listtran(X, Y) :-
%    listtran([eins|T],[one|T]),
%    listtran([zwei|T],[two|T]),
%    listtran([drei|T],[three|T]),
%    listtran([vier|T],[four|T]),
%    listtran([fuenf|T],[five|T]),
%    listtran([sechs|T],[six|T]),
%    listtran([sieben|T],[seven|T]),
%    listtran([acht|T],[eight|T]),
%    listtran([beyb|T],[nine|T]),
